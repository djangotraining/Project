...
if ((strpos($c_ser, 'javascript;') !== false) || (strpos($c_ser, ';javascript;') !== false) || ($c_ser == 'javascript')) {
	 $c_javascript = 1;
} else{
	 $c_javascript = 0;
} 

if ((strpos($c_ser, 'php;') !== false) || (strpos($c_ser, ';php;') !== false) || ($c_ser == 'php')) {
	 $c_php = 1;
} else{
	 $c_php = 0;
} 

if ((strpos($c_ser, 'python;') !== false) || (strpos($c_ser, ';python;') !== false) || ($c_ser == 'python')) {
	 $c_python = 1;
} else{
	 $c_python = 0;
} 

if ((strpos($c_ser, 'c#;') !== false) || (strpos($c_ser, ';c#;') !== false) ||($c_ser == 'c#')) {
	 $c_chash = 1;
} else{
	 $c_chash = 0;
} 
...
if ((strpos($c_ser, 'objective' ) !== false) || (strpos($c_ser, ';objective;' ) !== false)  || ($c_ser == 'objective c'))  {
	 $c_obj = 1;
} else{
	 $c_obj = 0;
}

if ((strpos($c_ser, 'swift;') !== false) || (strpos($c_ser, ';swift;') !== false) || ($c_ser == 'swift'))  {
	 $c_swift = 1;
} else{
	 $c_swift = 0;
}
